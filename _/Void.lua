...
local themes = {
    Default = {
        ["Accent"] = Color3.fromRGB(115, 95, 135),
    ...
    Midnight = {
        ["Accent"] = Color3.fromRGB(100, 60, 155),
...
local library = utility.table({theme = table.clone(themes.Default), folder = "vozoiduilib", extension = "vozoid", flags = {}, open = true, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, holder = nil, connections = {}}, true)
