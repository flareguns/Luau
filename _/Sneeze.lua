...
--local themes = {}
local theme = {
	accent = Color3.fromRGB(135, 100, 110),
	lightcontrast = Color3.fromRGB(35, 35, 45),
	darkcontrast = Color3.fromRGB(35, 35, 40),
	outline = Color3.fromRGB(25, 25, 30),
	inline = Color3.fromRGB(50, 50, 65),
	textcolor = Color3.fromRGB(145, 145, 150),
	textdark = Color3.fromRGB(115, 115, 120),
	textborder = Color3.fromRGB(35, 35, 45),
    font = 2,
    textsize = 13
}
-- // utility Functions
